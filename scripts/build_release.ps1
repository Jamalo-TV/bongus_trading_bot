...
Copy-ReleaseFile -Source (Join-Path $RepoRoot "scripts\run_paper_soak.py") -RelativeDestination "scripts\run_paper_soak.py"
...
Copy-ReleaseFile -Source (Join-Path $RepoRoot "bongus\testing\paper_soak.py") -RelativeDestination "bongus\testing\paper_soak.py"
